          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="addCiudad.html" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Ciudad</span></a>
            ...
            <table class="table table-servicios table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Francia</td>
                  <td>
                    <a href="modCiudad.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Modificar">&#xE254;</i></a>
                ...
                <tr>
                  ...
                  <td>Argentina</td>
                  <td>
                    <a href="modCiudad.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>Turquia</td>
                  <td>
                    <a href="modCiudad.html" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>

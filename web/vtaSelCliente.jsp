<%-- 
    Document   : vtaSelCliente
    Created on : 20/12/2021, 01:36:36 PM
    Author     : leand
--%>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="verCliente.html" class="view" title="Informacion Completa" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                    <a href="#editEmployeeModal" class="select" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Seleccionar Cliente">&#xE174;</i></a>
                  </td>
                </tr>
              </tbody>
            </table>

<%-- 
    Document   : verVenta
    Created on : 20/12/2021, 01:35:00 PM
    Author     : leand
--%>
        ...
        <div class="signup-content">
            <div class="signup-img">
                ...
                <div class="signup-img-content">
                    <h2>Informacion completa de la Venta</h2>
                </div>
            </div>
            <div class="container venta-confirmacion">
              ...
              <div>
                <div class="venta-confirmacion-item col">
                  <h5>Direccion</h5>
                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos fugiat beatae totam reiciendis. Blanditiis obcaecati, in quidem fuga autem earum voluptates quasi officiis pariatur, consequatur minus, id odit deserunt eos.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">

<%-- 
    Document   : adminMediosPago
    Created on : 20/12/2021, 01:30:00 PM
    Author     : leand
--%>
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-6">
                  <h2>Administrar <b>Medios de Pago</b></h2>
                </div>
                <div class="col-sm-6">
                  <a href="addCiudad.html" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Medio de Pago</span></a>
            ...
            <table class="table table-servicios table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>0</td>
                  <td>
                    <a href="modMedioPago.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Modificar">&#xE254;</i></a>
                ...
                <tr>
                  ...
                  <td>3</td>
                  <td>
                    <a href="modMedioPago.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>

<%-- 
    ...
    Created on : 20/12/2021, 01:29:41 PM
    Author     : leand
--%>
          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="addEmpleado.jsp" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Empleado</span></a>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>45134534</td>
                  <td>vendedor</td>
                  <td>av. libertador 2543, Cochabamba, Cordoba</td>
                  <td>correo3454@yimail.com</td>
                  <td>
                    <a href="verEmpleado.jsp" class="view" title="Informacion Completa" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                    <a href="modEmpleado.jsp" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

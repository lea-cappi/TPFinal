<%-- 
    Document   : adminTipoServicios
    Created on : 20/12/2021, 01:31:11 PM
    Author     : leand
--%>
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-6">
                  <h2>Administrar <b>Tipo de Servicios</b></h2>
                </div>
                <div class="col-sm-6">
                  <a href="addTipoServicio.html" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Tipo Servicio</span></a>
                  					
                </div>
              </div>
            </div>
            <table class="table table-individual table-striped table-hover">
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="modTipoServicio.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Modificar">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>
                  <td>Pasajes de avion</td>
                  <td>
                    <a href="modTipoServicio.html" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>
          ...
          <div class="modal-content">
            <form>
              ...
              <div class="modal-body">					
                <p>Estas seguro de eliminar este tipo de servicio?</p>

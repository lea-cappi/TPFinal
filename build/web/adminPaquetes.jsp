<%-- 
    ...
    Created on : 20/12/2021, 01:30:33 PM
    Author     : leand
--%>
          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="addPaquete.html" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Paquete</span></a>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  <td>Semana loca en Ibiza</td>
                  <td>Pasaje de ida y vuelta a Ibiza, 6 noches de hotel 4 estrellas sobre la costa, 4 entradas a discoteca premium, alquiler de auto por 7 dias, 2 dias de excursion en yate festivo.</td>
                  <td>$ 1870.00</td>
                  <td>
                    <a href="modPaquete.html" class="edit"><i class="material-icons" data-toggle="tooltip" title="Modificar">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>
                  <td>Viaje por Paris y Londres</td>
                  <td>Pasaje turista de avion Ezeiza-Paris, 3 noches de hotel de 3 estrellas en Paris, 2 entradas a Museo Louvre, pasaje de avion Paris-Londres, 3 noches de hotel 3 estrellas en Londres, tour grupal por Londres, pasaje turista de avion Londres-Ezeiza.</td>
                  <td>$ 870.00</td>
                  <td>
                    <a href="modPaquete.html" class="Modificar" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
              </tbody>

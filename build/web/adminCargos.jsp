<%-- 
    Document   : adminCargos
    Created on : 20/12/2021, 01:29:03 PM
    Author     : leand
--%>
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-6">
                  <h2>Administrar <b>Cargos de Empleados</b></h2>
                </div>
                <div class="col-sm-6">
                  <a href="addCargo.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Cargo</span></a>
            ...
            <table class="table  table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>40.000</td>
                  <td>
                    <a href="modCargo.jsp" class="edit"><i class="material-icons" data-toggle="tooltip" title="Modificar">&#xE254;</i></a>

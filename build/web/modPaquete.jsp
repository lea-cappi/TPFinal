<%-- 
    Document   : modPaquete
    Created on : 20/12/2021, 01:33:54 PM
    Author     : leand
--%>
    ...
    <header class="site-navbar" role="banner">
      ...
      <div class="container mt-5">
        <div class="table-responsive">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h1>Modificar <b>Paquete</b></h1>
            </div>
          </div>
          <form method="POST" class="table-form" id="table-form">
            <div class="row align-items-center">
              <div class="col-sm-6">
                <div class="row">
                  ...
                  <div class="table-form-select col-sm-6">
                    <div class="form-input">
                      <label>Descripcion</label>
                      <textarea rows="4" name="descripcion"></textarea>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 ">
                <div class="col">
                  ...
                  <div class="mt-4">
                    <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Modificar Paquete</span></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <table id="table-paquete" class="table table-striped table-hover">
              <thead>
                <tr>
                  <th>Ciudad</th>
                  <th>Tipo</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Hotel 4 estrellas ubicado en el centro de la ciudad.</td>
                  <td>$ 80.00</td>
                  <td>
            ...
            <table id="table-paquete" class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>$ 80.00</td>
                  <td>
                    <a href="modCiudad.html" class="add"><i class="material-icons" data-toggle="tooltip" title="Agregar">&#xE148;</i></a>
                  </td>
                </tr>
              </tbody>
            </table>

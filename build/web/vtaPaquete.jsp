<%-- 
    Document   : vtaPaquete
    Created on : 20/12/2021, 01:36:03 PM
    Author     : leand
--%>
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-8">
                  <h1>Seleccionar <b>Paquete</b> a Vender</h1>
                </div>
              </div>
            </div>
          </div>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>$ 1870.00</td>
                  <td>
                    <form action="frmSelectPaquete" action="SvAlgo" method="post">
                      <button type="submit"><a href="modCiudad.html" class="add"><i class="material-icons" data-toggle="tooltip" title="Vender">&#xE92f;</i></a></button>
                    </form>
                  </td>
                </tr>
              </tbody>

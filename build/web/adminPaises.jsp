<%-- 
    Document   : adminPaises
    Created on : 20/12/2021, 01:30:17 PM
    Author     : leand
--%>
          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="addPais.html" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Agregar Pais</span></a>
            ...
            <table class="table table-individual table-striped table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td>Indonesia</td>
                  <td>
                    <a href="modPais.html" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                  </td>
                </tr>
                <tr>
          ...
          <div class="modal-content">
            <form>
              ...
              <div class="modal-body">					
                <p>Estas seguro de eliminar este pais?</p>

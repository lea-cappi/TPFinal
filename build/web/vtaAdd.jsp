<%-- 
    Document   : vtaAdd
    Created on : 20/12/2021, 01:35:31 PM
    Author     : leand
--%>
            ...
            <form method="POST" class="register-form" id="register-form">
              <div class="form-group row">
                <div class="form-input col-sm-6">
                  <h2 style="color: #435d7d">Cliente Existente</h2>
                </div>
                <div class="form-submit col-sm-6">
                  <input type="submit" value="Seleccionar" class="submit" name="submit" id="submit"/>
                </div>
              </div>
            </form>
            <form method="POST" class="register-form" id="register-form">
              <div class="form-group row">
                <div class="form-input col-sm-6">
                  <h2 style="color: #435d7d">Nuevo Cliente</h2>
                </div>
                <div class="form-submit col-sm-6">

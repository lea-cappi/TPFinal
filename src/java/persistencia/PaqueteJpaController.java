    ...
    public void create(Paquete paquete) {
        ...
        try {
            ...
            for (Servicio listaServiciosServicioToAttach : paquete.getListaServicios()) {
                listaServiciosServicioToAttach = em.getReference(listaServiciosServicioToAttach.getClass(), listaServiciosServicioToAttach.getIdServicio());
    ...
    public void edit(Paquete paquete) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Servicio listaServiciosNewServicioToAttach : listaServiciosNew) {
                listaServiciosNewServicioToAttach = em.getReference(listaServiciosNewServicioToAttach.getClass(), listaServiciosNewServicioToAttach.getIdServicio());

    ...
    public void create(Servicio servicio) {
        ...
        try {
            ...
            for (Paquete listaPaquetesPaqueteToAttach : servicio.getListaPaquetes()) {
                listaPaquetesPaqueteToAttach = em.getReference(listaPaquetesPaqueteToAttach.getClass(), listaPaquetesPaqueteToAttach.getIdPaquete());
    ...
    public void edit(Servicio servicio) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Paquete listaPaquetesNewPaqueteToAttach : listaPaquetesNew) {
                listaPaquetesNewPaqueteToAttach = em.getReference(listaPaquetesNewPaqueteToAttach.getClass(), listaPaquetesNewPaqueteToAttach.getIdPaquete());
